...
- `config/west.yml` pins one ZMK commit (Zephyr 4.1, board `nice_nano//zmk`); `.github/workflows/build.yml` must use the same commit. Do not bump ZMK or track `main` without being asked.
